...
},{"_css_loader":"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"page.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
var $button3 = (0, _jquery.default)('#multi');
...
$tabBar.on('click', 'li', function (e) {
  ...
  var $li = (0, _jquery.default)(e.currentTarget); //获取jquery元素

  $li.addClass('selected').siblings().removeClass('selected');
  var index = $li.index();
  $tabContent.children().eq(index).addClass('active').siblings().removeClass('active'); //eq是等于第几个 eq（index）找第index个
});
$tabBar.children().eq(0).trigger('click'); //在初始状态下设置第一个tabbar为click的状态
...
$square.on('click', function () {
  $square.toggleClass('active'); //如果没有这个class就加上 如果有就删掉
});
...
require("./app4.js");
},{"./reset.css":"reset.css","./page.css":"page.css","./app1.js":"app1.js","./app2.js":"app2.js","./app3.js":"app3.js","./app4.js":"app4.js"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
